...
* [Preload Controls generated by function arguments into NamedControl](https://github.com/avdrd/supercollider/tree/topic/NamedControl-preload-func-args) for a somewhat more unified controls namespace. See [##5648](https://github.com/supercollider/supercollider/issues/5648) for motivation.
* [SynthDef.build posthook](https://github.com/avdrd/supercollider/tree/topic/SynthDef.build-changed-posthook) For users who forget to `add` their SynthDefs and similar automation purposes. See [#5656](https://github.com/supercollider/supercollider/issues/5656) for an example how to use it.
